...
async def game_casino(message):
    ...
    coff_dict = {
        0: [2, 1.75, 1.5, 1.25, 0.75, 0.5, 0.25, 0.1, 0],
        1: [10, 2, 1.75, 1.5, 1.25, 0.75, 0.5, 0.25],
        2: [10, 5, 3, 2, 1.75, 1.5, 1.25, 0.75, 0.50],
        3: [10, 5, 4, 2, 1.80, 1.65, 1.25, 0.70],
        4: [10, 5, 2.25, 1.75, 1.5, 1.25, 0.75, 0.5],
    }
