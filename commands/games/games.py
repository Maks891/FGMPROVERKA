...
async def game_casino(message):
    ...
    coff_dict = {
        0: [2, 1.75, 1.5, 1.25, 0.75, 0.5, 0],
        1: [2, 1.25, 0, 0.5, 0.25],
        2: [5, 1.5,  0.75, 0],
        3: [5, 1.25, 0.70, 0],
        4: [10, 5, 0, 1.5, 0.75, 0.1, 0.5, 0, 1.5, 0.75, 0.1, 0.5, 0, 1.5, 0.75, 0.1, 0.5, 0, 1.5, 0.75, 0.1, 0.5, 0, 1.5, 0.75, 0.1, 0.5, 0, 1.5, 0.75, 0.1, 0.5, 0, 1.5, 0.75, 0.1, 0.5, 1.5, 1.5, 1.5, 1.5],
    }
