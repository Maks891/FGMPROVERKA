...
async def game_casino(message):
    ...
    coff_dict = {
        0: [2, 1.75, 1.5, 1.25, 0.75, 0.5, 0.25, 0.1, 0.3, 0, 10],
        1: [2, 1.75, 1.5, 1.25, 0.75, 0.5, 0.25, 0.1, 0.2, 0, 10],
        2: [2.25, 2, 1.75, 1.5, 1.25, 0.75, 0.5, 0.1, 0.3, 0, 10],
        3: [2.5, 2, 1.75, 1.5, 1.25, 0.75, 0.5, 0.1, 0, 10],
        4: [2.5, 2, 0.5, 0.3, 0.2, 0.1, 0, 10]
    }
